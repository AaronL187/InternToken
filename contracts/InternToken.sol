    ...
    TokenEvents
{
    ...
    {
        mint(recipient, 500000 * 10 ** 18);
        emit Mint(recipient, 500000 * 10 ** 18);
    }
    ...
    function _update(
        ...
        require(
            value > 0,
            "InternToken: transfer amount must be greater than 0"
        );
        require(
            balanceOf(from) >= value,
            "InternToken: transfer amount exceeds balance"
        );
    ...
    function burn(uint256 _amount) public virtual override {
        ...
        require(
            ...
            "InternToken: burn amount exceeds balance"
        );
